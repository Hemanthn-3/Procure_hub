  ...
  return (
    <div className="page-container">
      ...
      <div className="bidbox__layout">
        {/* PO Details */}
        {po && (
          <div className="bidbox__details glass-card">
            <div className="bidbox__details-inner">
              <div className="bidbox__header">
        ...
        {/* Bidding Form */}
        <div className="bidbox__form-card glass-card">
          <div className="bidbox__form-inner">
            ...
            {!success && (
              <form onSubmit={handleSubmit} className="bidbox__form" id="bid-form">
                <div className="form-group">
                  ...
                  <div className="bidbox__input-wrapper">
                    ...
                    <input
                      id="bid-amount"
                      type="number"
                      className="form-input bidbox__amount-input"
                      placeholder="0.00"
                ...
                <div className="form-group">
                  <label className="form-label" htmlFor="delivery-days">
